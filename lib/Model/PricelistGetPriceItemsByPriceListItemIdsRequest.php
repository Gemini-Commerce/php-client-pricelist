...
/**
 * PricelistGetPriceItemsByPriceListItemIdsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PricelistGetPriceItemsByPriceListItemIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pricelistGetPriceItemsByPriceListItemIdsRequest';
    ...
    */
    ...
    public function setPriceListItemId($price_list_item_id)
    {
        if (is_null($price_list_item_id)) {
            throw new \InvalidArgumentException('non-nullable price_list_item_id cannot be null');
        }
