...
/**
 * PricelistUpdatePriceListRequestPayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PricelistUpdatePriceListRequestPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pricelistUpdatePriceListRequestPayload';
    ...
    protected static $openAPITypes = [
        ...
        'markets' => 'string[]',
        'channels' => 'string[]',
        'type' => '\OpenAPI\Client\Model\PricelistPriceListType',
        'is_system' => 'bool',
        'name' => 'string',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\PricelistPriceListType|null $type type
     *
     * @return self
     */
